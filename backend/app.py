...
joblib.dump(rf, 'random_forest_model2.pkl')

print("✅ Model saved as 'random_forest_model2.pkl'")
...
joblib.dump(le5, 'label_encoder2.pkl')

print("✅ LabelEncoder saved as 'label_encoder2.pkl'")
...
joblib.dump(le1, 'age_group_encoder2.pkl')
joblib.dump(le2, 'location_encoder2.pkl')
joblib.dump(le3, 'diet_encoder2.pkl')
joblib.dump(le4, 'transport_encoder2.pkl')

# Load trained model and label encoder (assuming you saved them previously)
rf = joblib.load("random_forest_model2.pkl")
le5 = joblib.load("label_encoder2.pkl")  # For recommended_action
le_age_group = joblib.load("age_group_encoder2.pkl")  # For age_group encoding
le_location = joblib.load("location_encoder2.pkl")  # For location encoding
le_diet = joblib.load("diet_encoder2.pkl")  # For diet encoding
le_transport = joblib.load("transport_encoder2.pkl")  # For transport encoding
...
if submitted:
    ...
    st.write("Mood:", mood)
    st.write("Context Location:", context_location)
    st.write("Companion:", companion)
    st.write("Device:", device)
    st.write("Sustainability Goal:", goal)
    st.write("Recommended Action:", best_action.replace('_', ' ').title())